...
// Demo sadiqlik yaddaşı (simulyasiya). Nömrənin son 7 rəqəmi açar kimi istifadə olunur.
// "7777777" ilə bitən nömrə artıq 9 gəlişdədir — növbəti təsdiq 10-cu (hədiyyə) olur.
const visitStore = new Map<string, number>([['7777777', 9]])
